...
enum Retcode {
  ...
  Retcode_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Retcode_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool Retcode_IsValid(int value);
const Retcode Retcode_MIN = RET_FAIL;
const Retcode Retcode_MAX = RET_GCG_LEVEL_REWARD_NO_REWARD;
...
template <> struct is_proto_enum< ::proto::Retcode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::Retcode>() {
  return ::proto::Retcode_descriptor();
}
