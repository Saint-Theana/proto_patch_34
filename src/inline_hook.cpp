...
HookStatus FakeItSafe(void *oldfunc, void **poutold,
    ...
    const int jmplen = GetJmpLenLarge();
    ...
    for (int i = 0; i < num_patch_points; i++) {
        ...
        case FHPatchLoad32:
            ...
            if (delta > INT_MAX || delta < INT_MIN) {
                ...
                return FakeItSafe(oldfunc, poutold, need_checking,
                                  oldfunc);
            }
...
HookStatus FakeIt(void *oldfunc, void **poutold) {
    return FakeItSafe(oldfunc, poutold, 1, nullptr);
}
